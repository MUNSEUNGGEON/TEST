...
namespace DataBaseManager
{
    public class DatabaseManager
    {
        ...
        public bool ValidateUser(string userId, string password)
        {
            ...
            const string query =
                "SELECT COUNT(*) FROM login WHERE id = @userId AND pw = @password";
            ...
            out string? errorMessage)
        {
            const string query =
                ...
                "TUL_USER_ID, TUL_USER_PW, TUL_USER_NAME, TUL_USER_EMAIL, TUL_USER_TYPE, TUL_USER_DEPT, TUL_USER_POSITION" +
                ") VALUES (" +
